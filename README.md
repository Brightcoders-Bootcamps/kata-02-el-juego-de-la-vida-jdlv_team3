...
## Nuevo requerimiento
Tu solución, además de ser orientada a objetos e incluir pruebas unitarias ahora incluirá el uso de una herramienta para la evaluación de la calidad de tu código.

La herramienta que vamos a utilizar es [CodeClimate](https://codeclimate.com/). Esta herramienta evalua diferentes aspectos de tu código y te genera análisis junto con una calificación que determina la calidad de tu código.

Deberás asegurarte de que la calificación obtenida en esta herramienta sea A.
